...
- **Открыть расположение файла** — клик по файлу пытается открыть папку в системе (если браузер блокирует `file:///`, путь копируется).
...
- `scanner.py` — рекурсивное сканирование директории в древовидную структуру (в текущем UI не задействован).
- `state.py` — общее состояние (пока минимально).
